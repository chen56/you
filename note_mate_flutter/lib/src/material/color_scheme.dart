  ...
  ColorScheme$Mate({
    ...
    mateParams = Params(
      ...
      builder: (p) => ColorScheme$Mate(
        ...
        primaryVariant: p.getValue('primaryVariant'),
        secondaryVariant: p.getValue('secondaryVariant'),
      ),
    );
    ...
    mateParams.set(name: 'primaryVariant', init: primaryVariant);
    mateParams.set(name: 'secondaryVariant', init: secondaryVariant);
  }
