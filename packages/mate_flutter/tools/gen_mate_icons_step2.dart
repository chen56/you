...
Future<void> genAll({
  ...
  var icons = declareConst('icons')
      .assign(literalConstMap(
        Map.fromEntries(iconRegister.icons.entries.map((e) =>
            MapEntry(literalNum(e.key.codePoint), literalString(e.value)))),
        refer("int"),
        refer("String"),
      ))
      .statement;
