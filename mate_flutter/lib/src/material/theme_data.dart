...
class ThemeData$Mate extends _i1.ThemeData with _i2.Mate {
  ...
  ThemeData$Mate.raw({
    /// optionalParameters: {required Map<Type, Adaptation<Object>> adaptationMap} , default:none
    ...
    required super.tooltipTheme,
          ...
          'adaptationMap': _i2.BuilderArg<Map<Type, _i1.Adaptation<Object>>>(
            name: 'adaptationMap',
            init: adaptationMap,
            isNamed: true,
          ),
    ...
    mateBuilder = (p) => ThemeData$Mate.raw(
          adaptationMap: p.get('adaptationMap').build(),
