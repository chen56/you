// /// Generated by mate_flutter, please don't edit! Created time: 2023-03-11 13:17:26.172709
...
abstract class StreamBuilderBase$Mate<T, S> extends StreamBuilderBase<T, S> {
  /// StreamBuilderBase<T, S> StreamBuilderBase({Key? key, Stream<T>? stream})
  StreamBuilderBase$Mate({
    /// param: {Key? key}
    Key? key,
...
class AsyncSnapshot$Mate<T> extends AsyncSnapshot<T> {
...
class StreamBuilder$Mate<T> extends StreamBuilder<T> {
...
class FutureBuilder$Mate<T> extends FutureBuilder<T> {
