// /// Generated by mate_flutter, please don't edit! Created time: 2023-03-09 14:20:09.493722
...
class TextTreeConfigurationMate extends TextTreeConfiguration {
...
class TextTreeRendererMate extends TextTreeRenderer {
...
abstract class DiagnosticsNodeMate extends DiagnosticsNode {
...
class MessagePropertyMate extends MessageProperty {
...
class StringPropertyMate extends StringProperty {
...
class DoublePropertyMate extends DoubleProperty {
...
class IntPropertyMate extends IntProperty {
...
class PercentPropertyMate extends PercentProperty {
...
class FlagPropertyMate extends FlagProperty {
...
class IterablePropertyMate<T> extends IterableProperty<T> {
...
class EnumPropertyMate<T> extends EnumProperty<T> {
...
class ObjectFlagPropertyMate<T> extends ObjectFlagProperty<T> {
...
class FlagsSummaryMate<T> extends FlagsSummary<T> {
...
class DiagnosticsPropertyMate<T> extends DiagnosticsProperty<T> {
...
class DiagnosticableNodeMate<T extends Diagnosticable> extends DiagnosticableNode<T> {
...
class DiagnosticableTreeNodeMate extends DiagnosticableTreeNode {
...
class DiagnosticPropertiesBuilderMate extends DiagnosticPropertiesBuilder {
...
class DiagnosticsBlockMate extends DiagnosticsBlock {
