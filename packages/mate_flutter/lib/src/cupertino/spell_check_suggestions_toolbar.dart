...
class CupertinoSpellCheckSuggestionsToolbar$Mate
    extends _i1.CupertinoSpellCheckSuggestionsToolbar with _i2.Mate {
  ...
  CupertinoSpellCheckSuggestionsToolbar$Mate.editableText({
    ...
    matePackageUrl = 'package:flutter/cupertino.dart';
    mateBuilder =
        (p) => CupertinoSpellCheckSuggestionsToolbar$Mate.editableText(
              key: p.get('key').build(),
