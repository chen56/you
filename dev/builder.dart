...
class MateBuilder implements Builder {
  ...
  void showLib(StringBuffer sb, LibraryElement libraryElement) {
    sb.writeln("libraryElement ${libraryElement.name}");
    libraryElement.exportNamespace.definedNames.forEach((key, value) {
      if (value is ClassElement) {
        ...
        for (var constructor in value.constructors) {
          ...
          for (var parameter in constructor.parameters) {
            sb.writeln("      parameter${parameter.name}  ${parameter.type}   ${parameter}");
          }
        }
      }
    });
