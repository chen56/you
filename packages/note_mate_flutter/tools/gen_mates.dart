...
main() async {
  ...
  gen(
    ...
    writeTo: (libPath) {
      String toFile = path.join("lib", libPath);
      _log("output: $toFile");
      return toFile;
    },
...
Future<void> gen({
  ...
  _log("## gen enum editor:");
  {
    ...
    */
    ...
    var statements = allTypes.keys.whereType<EnumElement>().map((e) => refer("result")
        .index(allTypes.elementRef(e, debugRef: e))
        .assign(allTypes.elementRef(e, debugRef: e).property("values"))
        .statement);
