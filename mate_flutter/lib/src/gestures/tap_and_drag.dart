...
import 'package:flutter/src/gestures/tap_and_drag.dart' as _i1;
...
class TapDragDownDetails$Mate extends _i1.TapDragDownDetails with _i2.Mate {
  /// TapDragDownDetails TapDragDownDetails({required Offset globalPosition, required Offset localPosition, PointerDeviceKind? kind, required int consecutiveTapCount})
...
class TapDragUpDetails$Mate extends _i1.TapDragUpDetails with _i2.Mate {
  /// TapDragUpDetails TapDragUpDetails({required PointerDeviceKind kind, required Offset globalPosition, required Offset localPosition, required int consecutiveTapCount})
...
class TapDragStartDetails$Mate extends _i1.TapDragStartDetails with _i2.Mate {
  /// TapDragStartDetails TapDragStartDetails({Duration? sourceTimeStamp, required Offset globalPosition, required Offset localPosition, PointerDeviceKind? kind, required int consecutiveTapCount})
...
class TapDragUpdateDetails$Mate extends _i1.TapDragUpdateDetails with _i2.Mate {
  /// TapDragUpdateDetails TapDragUpdateDetails({Duration? sourceTimeStamp, Offset delta = Offset.zero, double? primaryDelta, required Offset globalPosition, PointerDeviceKind? kind, required Offset localPosition, required Offset offsetFromOrigin, required Offset localOffsetFromOrigin, required int consecutiveTapCount})
...
class TapDragEndDetails$Mate extends _i1.TapDragEndDetails with _i2.Mate {
  /// TapDragEndDetails TapDragEndDetails({Velocity velocity = Velocity.zero, double? primaryVelocity, required int consecutiveTapCount})
