...
main() async {
  ...
  for (final context in collection.contexts) {
    ...
    for (final filePath in root.analyzedFiles()) {
      ...
      resolvedLibs.add(_Page(filePath, resolvedLib, writeFS, dartFormatter));
    }
    ...
    genPages(resolvedLibs.map((e) => e.lib), writeFS: writeFS, dartFormatter: dartFormatter);
...
void genPages(
  ...
  toCode = dartFormatter.format(toCode);
...
class _Page {
  ...
  _Page(this.fullPath, this.libResult, this.writeFS, this.dartFormatter);
  ...
  _NoteInfo collectPageInfo() {
    ...
    return (
      ...
      header: (offset: 0, end: buildBodyBlock.leftBracket.end, cellStatements: []),
      body: body,
      // from:build end '}' to: file end
      tail: (offset: buildBodyBlock.rightBracket.offset, end: unit.end, cellStatements: [])
    );
  }
