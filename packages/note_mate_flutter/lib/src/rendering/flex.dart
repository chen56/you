...
import 'package:flutter/src/rendering/flex.dart';import 'dart:core';import 'package:flutter/src/rendering/box.dart';import 'package:flutter/src/painting/basic_types.dart';import 'dart:ui';import 'package:note/mate.dart' show Mate;/// class RenderFlex extends RenderBox with ContainerRenderObjectMixin<RenderBox, FlexParentData>, RenderBoxContainerDefaultsMixin<RenderBox, FlexParentData>, DebugOverflowIndicatorMixin
...
RenderFlex$Mate({/// optionalParameters: {List<RenderBox>? children} , hasDefaultValue:false, defaultValueCode:null
List<RenderBox>? children, /// optionalParameters: {Axis direction = Axis.horizontal} , hasDefaultValue:true, defaultValueCode:Axis.horizontal
required Axis direction, /// optionalParameters: {MainAxisSize mainAxisSize = MainAxisSize.max} , hasDefaultValue:true, defaultValueCode:MainAxisSize.max
required MainAxisSize mainAxisSize, /// optionalParameters: {MainAxisAlignment mainAxisAlignment = MainAxisAlignment.start} , hasDefaultValue:true, defaultValueCode:MainAxisAlignment.start
required MainAxisAlignment mainAxisAlignment, /// optionalParameters: {CrossAxisAlignment crossAxisAlignment = CrossAxisAlignment.center} , hasDefaultValue:true, defaultValueCode:CrossAxisAlignment.center
