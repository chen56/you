...
import 'package:flutter/src/widgets/container.dart';import 'package:flutter/src/foundation/key.dart';import 'package:flutter/src/painting/decoration.dart';import 'package:flutter/src/rendering/proxy_box.dart';import 'package:flutter/src/widgets/framework.dart';import 'package:flutter/src/painting/alignment.dart';import 'package:flutter/src/painting/edge_insets.dart';import 'dart:ui';import 'dart:core';import 'package:flutter/src/rendering/box.dart';import 'package:vector_math/vector_math_64.dart';import 'package:note/mate.dart' show Mate;/// class DecoratedBox extends SingleChildRenderObjectWidget
class DecoratedBox$Mate extends DecoratedBox with Mate {/// DecoratedBox DecoratedBox({Key? key, required Decoration decoration, DecorationPosition position = DecorationPosition.background, Widget? child})
DecoratedBox$Mate({/// optionalParameters: {Key? key} , hasDefaultValue:false, defaultValueCode:null
Key? key, /// optionalParameters: {required Decoration decoration} , hasDefaultValue:false, defaultValueCode:null
...
required DecorationPosition position, /// optionalParameters: {Widget? child} , hasDefaultValue:false, defaultValueCode:null
Widget? child, }) : super(key: key, decoration: decoration, position: position, child: child, ) { mateBuilder = (p) => DecoratedBox$Mate(key: p.get('key').build(), decoration: p.get('decoration').build(), position: p.get('position').build(), child: p.get('child').build(), );
matePut('key', key);
...
Container$Mate({/// optionalParameters: {Key? key} , hasDefaultValue:false, defaultValueCode:null
