...
学习资源赶不上技术进步。所以，我还想撰写一些核心概念的专题文章，来印证我对flutter的理解。
...
较为独立的、主要不是用来做容器的，具有特殊功能性，自身就是为了呈现某些内容的组件，一般比较小，也有例外，比如编辑器等：
