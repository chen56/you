  ...
  return (
    <>
      ...
      <div class="flex flex-row">
        ...
        */}
        <div class="grow-0 shrink-0	basis-64" >bg-white bg-white bg-white bg-white bg-white bg-white bg-white bg-white bg-white bg-white </div>
        ...
        <div class="grow-0 shrink-0	basis-64 " >bg-white bg-red bg-white bg-red bg-white bg-red bg-white bg-red bg-white bg-red bg-white bg-red bg-white bg-red bg-white bg-red </div>
      </div>
