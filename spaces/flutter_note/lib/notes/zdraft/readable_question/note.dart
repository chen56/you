...
好了，综上，我们模仿一下jsx/html的思维，看看是不是舒适很多：
...
一说到flutter的嵌套地狱，难以阅读，很多人就说是你代码没写好，怎么不去组件化控制嵌套层级呢，
但我们发现，flutter和jsx/html的多层嵌套可读性，其根源，是属性与子元素是否分离的设计，大脑理解代码骨干的速度全靠怎么忽略细枝末节信息，
这是代码可读性的本质性设计问题，扫了一眼类似的swiftui,也是类似问题。

除了上面讨论的视觉外，flutter倾向于一切皆组件，优点自然都吹了无数了，我们这里不讲，单讲两个恶果：因为所有都组件嵌套的级数自然是升高的，
这也是代码复杂性的设计性问题，另外组件太多了，组件爆炸了啊，这么多组件看着目录都累。
