...
abstract class BaseNotes {
  ...
  final Note zdraft_macos = put2(
      "zdraft/macos", zdraft_macos_g.noteInfo(), () => zdraft_macos_.loadLibrary().then((value) => zdraft_macos_.page));
  ...
  final Note root = put2("note.dart", root_g.noteInfo(), () => root_.loadLibrary().then((value) => root_.page));
}
