// /// Generated by mate_flutter, please don't edit! Created time: 2023-03-11 00:36:15.254990
...
class DirectionalityMate extends Directionality {
...
class OpacityMate extends Opacity {
...
class ShaderMaskMate extends ShaderMask {
...
class BackdropFilterMate extends BackdropFilter {
...
class CustomPaintMate extends CustomPaint {
...
class ClipRectMate extends ClipRect {
...
class ClipRRectMate extends ClipRRect {
...
class ClipOvalMate extends ClipOval {
...
class ClipPathMate extends ClipPath {
...
class PhysicalModelMate extends PhysicalModel {
...
class PhysicalShapeMate extends PhysicalShape {
...
class TransformMate extends Transform {
...
class CompositedTransformTargetMate extends CompositedTransformTarget {
...
class CompositedTransformFollowerMate extends CompositedTransformFollower {
...
class FittedBoxMate extends FittedBox {
...
class FractionalTranslationMate extends FractionalTranslation {
...
class RotatedBoxMate extends RotatedBox {
...
class PaddingMate extends Padding {
...
class CenterMate extends Center {
...
class CustomSingleChildLayoutMate extends CustomSingleChildLayout {
...
class LayoutIdMate extends LayoutId {
...
class CustomMultiChildLayoutMate extends CustomMultiChildLayout {
...
class SizedBoxMate extends SizedBox {
...
class ConstrainedBoxMate extends ConstrainedBox {
...
class ConstraintsTransformBoxMate extends ConstraintsTransformBox {
...
class UnconstrainedBoxMate extends UnconstrainedBox {
...
class FractionallySizedBoxMate extends FractionallySizedBox {
...
class LimitedBoxMate extends LimitedBox {
...
class OverflowBoxMate extends OverflowBox {
...
class SizedOverflowBoxMate extends SizedOverflowBox {
...
class OffstageMate extends Offstage {
...
class AspectRatioMate extends AspectRatio {
...
class IntrinsicWidthMate extends IntrinsicWidth {
...
class IntrinsicHeightMate extends IntrinsicHeight {
...
class BaselineMate extends Baseline {
...
class SliverToBoxAdapterMate extends SliverToBoxAdapter {
...
class SliverPaddingMate extends SliverPadding {
...
class ListBodyMate extends ListBody {
...
class IndexedStackMate extends IndexedStack {
...
class PositionedMate extends Positioned {
...
class PositionedDirectionalMate extends PositionedDirectional {
...
class ColumnMate extends Column {
...
class FlexibleMate extends Flexible {
...
class ExpandedMate extends Expanded {
...
class RichTextMate extends RichText {
...
class RawImageMate extends RawImage {
...
class DefaultAssetBundleMate extends DefaultAssetBundle {
...
class WidgetToRenderBoxAdapterMate extends WidgetToRenderBoxAdapter {
...
class ListenerMate extends Listener {
...
class MouseRegionMate extends MouseRegion {
...
class RepaintBoundaryMate extends RepaintBoundary {
...
class IgnorePointerMate extends IgnorePointer {
...
class AbsorbPointerMate extends AbsorbPointer {
...
class MetaDataMate extends MetaData {
...
class SemanticsMate extends Semantics {
...
class MergeSemanticsMate extends MergeSemantics {
...
class BlockSemanticsMate extends BlockSemantics {
...
class ExcludeSemanticsMate extends ExcludeSemantics {
...
class IndexedSemanticsMate extends IndexedSemantics {
...
class KeyedSubtreeMate extends KeyedSubtree {
...
class BuilderMate extends Builder {
...
class StatefulBuilderMate extends StatefulBuilder {
...
class ColoredBoxMate extends ColoredBox {
