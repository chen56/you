...
import 'package:flutter_web/pages/dev/debug/page.dart' deferred as dev_debug_;
import 'package:flutter_web/pages/dev/devtool/page.dart' deferred as dev_devtool_;
import 'package:flutter_web/pages/dev/devtool/vmservice/page.dart' deferred as dev_devtool_vmservice_;
import 'package:flutter_web/pages/dev/host_mirror/page.dart' deferred as dev_host_mirror_;
import 'package:flutter_web/pages/dev/macos_config/page.dart' deferred as dev_macos_config_;
import 'package:flutter_web/pages/env_info/page.dart' deferred as env_info_;
import 'package:flutter_web/pages/i18n/page.dart' deferred as i18n_;
import 'package:flutter_web/pages/Improve_app/1.overview/page.dart' deferred as Improve_app_overview_;
import 'package:flutter_web/pages/Improve_app/event&listener&lifeycle/page.dart' deferred as Improve_app_event_listener_lifeycle_;
import 'package:flutter_web/pages/Improve_app/page.dart' deferred as Improve_app_;
import 'package:flutter_web/pages/Improve_app/RepaintBoundary/page.dart' deferred as Improve_app_RepaintBoundary_;
import 'package:flutter_web/pages/Improve_app/web_optimization/page.dart' deferred as Improve_app_web_optimization_;
import 'package:flutter_web/pages/layout/box_layout/constraints/page.dart' deferred as layout_box_layout_constraints_;
import 'package:flutter_web/pages/layout/old/layout/page.dart' deferred as layout_old_layout_;
import 'package:flutter_web/pages/layout/page.dart' deferred as layout_;
import 'package:flutter_web/pages/layout/responsive_design/page.dart' deferred as layout_responsive_design_;
import 'package:flutter_web/pages/media&assets&file/assets/page.dart' deferred as media_assets_file_assets_;
import 'package:flutter_web/pages/media&assets&file/file_desktop/page.dart' deferred as media_assets_file_file_desktop_;
import 'package:flutter_web/pages/media&assets&file/file_web/page.dart' deferred as media_assets_file_file_web_;
import 'package:flutter_web/pages/navigation/page.dart' deferred as navigation_;
import 'package:flutter_web/pages/page.dart' deferred as root_;
import 'package:flutter_web/pages/pure_dart/analyzer/page.dart' deferred as pure_dart_analyzer_;
import 'package:flutter_web/pages/pure_dart/async/page.dart' deferred as pure_dart_async_;
import 'package:flutter_web/pages/pure_dart/dart3/page.dart' deferred as pure_dart_dart3_;
import 'package:flutter_web/pages/pure_dart/execption/page.dart' deferred as pure_dart_execption_;
import 'package:flutter_web/pages/pure_dart/safe_interface/page.dart' deferred as pure_dart_safe_interface_;
import 'package:flutter_web/pages/pure_dart/serialization_json/page.dart' deferred as pure_dart_serialization_json_;
import 'package:flutter_web/pages/research/remote_view/page.dart' deferred as research_remote_view_;
import 'package:flutter_web/pages/research/research_parameterized_example/page.dart' deferred as research_research_parameterized_example_;
import 'package:flutter_web/pages/state/1.vanilla_state/page.dart' deferred as state_vanilla_state_;
import 'package:flutter_web/pages/state/page.dart' deferred as state_;
import 'package:flutter_web/pages/state/StatefulBuilder/page.dart' deferred as state_StatefulBuilder_;
import 'package:flutter_web/pages/style&theming/material3/page.dart' deferred as style_theming_material3_;
import 'package:flutter_web/pages/thinking_in_ui/readable_html_vs_dart/page.dart' deferred as thinking_in_ui_readable_html_vs_dart_;
import 'package:flutter_web/pages/widgets/container_widgets/bar/page.dart' deferred as widgets_container_widgets_bar_;
import 'package:flutter_web/pages/widgets/container_widgets/menu/page.dart' deferred as widgets_container_widgets_menu_;
import 'package:flutter_web/pages/widgets/container_widgets/scrollable/Dismissible/page.dart' deferred as widgets_container_widgets_scrollable_Dismissible_;
import 'package:flutter_web/pages/widgets/specific_widgets/button/ButtonStyleButton/page.dart' deferred as widgets_specific_widgets_button_ButtonStyleButton_;
import 'package:flutter_web/pages/widgets/specific_widgets/button/FloatingActionButton/page.dart' deferred as widgets_specific_widgets_button_FloatingActionButton_;
import 'package:flutter_web/pages/widgets/specific_widgets/button/IconButton/page.dart' deferred as widgets_specific_widgets_button_IconButton_;
import 'package:flutter_web/pages/widgets/specific_widgets/button/overview/page.dart' deferred as widgets_specific_widgets_button_overview_;
import 'package:flutter_web/pages/widgets/specific_widgets/icon/page.dart' deferred as widgets_specific_widgets_icon_;
import 'package:flutter_web/pages/widgets/specific_widgets/input/page.dart' deferred as widgets_specific_widgets_input_;
import 'package:flutter_web/pages/widgets/specific_widgets/selectable/page.dart' deferred as widgets_specific_widgets_selectable_;
import 'package:flutter_web/pages/widgets/specific_widgets/slider/page.dart' deferred as widgets_specific_widgets_slider_;
import 'package:flutter_web/pages/widgets/specific_widgets/text/RichText/page.dart' deferred as widgets_specific_widgets_text_RichText_;
import 'package:flutter_web/pages/widgets/specific_widgets/text/Text/page.dart' deferred as widgets_specific_widgets_text_Text_;
import 'package:flutter_web/pages/widgets/specific_widgets/webview/page.dart' deferred as widgets_specific_widgets_webview_;
import 'package:flutter_web/pages/x.note_inside/1.welcome/page.dart' deferred as x_note_inside_welcome_;
import 'package:flutter_web/pages/x.note_inside/how_note_work/page.dart' deferred as x_note_inside_how_note_work_;
import 'package:flutter_web/pages/x.note_inside/mockup_content/page.dart' deferred as x_note_inside_mockup_content_;
import 'package:flutter_web/pages/x.note_inside/note_test_self/nobody/page.dart' deferred as x_note_inside_note_test_self_nobody_;
import 'package:flutter_web/pages/x.note_inside/note_test_self/page.dart' deferred as x_note_inside_note_test_self_;
