// /// Generated by mate_flutter, please don't edit! Created time: 2023-03-11 13:17:26.542452
...
abstract class OverlayRoute$Mate<T> extends OverlayRoute<T> {
...
abstract class TransitionRoute$Mate<T> extends TransitionRoute<T> {
  /// TransitionRoute<T> TransitionRoute({RouteSettings? settings})
  TransitionRoute$Mate(
      {
      /// param: {RouteSettings? settings}
      RouteSettings? settings})
      : super(settings: settings) {}
...
class LocalHistoryEntry$Mate extends LocalHistoryEntry {
...
abstract class ModalRoute$Mate<T> extends ModalRoute<T> {
...
abstract class PopupRoute$Mate<T> extends PopupRoute<T> {
...
class RawDialogRoute$Mate<T> extends RawDialogRoute<T> {
