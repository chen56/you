...
abstract class BaseNotes {
  ...
  final NoteRoute media_assets_file_file_desktop                       = put("/media&assets&file/file_desktop",media_assets_file_file_desktop_g.noteInfo(), (note) async => note.lazyInit(builder:await media_assets_file_file_desktop_.loadLibrary().then((value) => media_assets_file_file_desktop_.build)));
  final NoteRoute media_assets_file_file_web                           = put("/media&assets&file/file_web",media_assets_file_file_web_g.noteInfo(), (note) async => note.lazyInit(builder:await media_assets_file_file_web_.loadLibrary().then((value) => media_assets_file_file_web_.build)));
  ...
  final NoteRoute style_theming_material3                              = put("/style&theming/material3",style_theming_material3_g.noteInfo(), (note) async => note.lazyInit(builder:await style_theming_material3_.loadLibrary().then(  (value) {
    NotePageBuilder b=style_theming_material3_.build;
    return b;
  })));
