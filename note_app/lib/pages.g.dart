...
import 'package:note_app/note/components/button/ElevatedButton/@page.dart'
...
import 'package:note_app/note/components/text/RichText/@page.dart'
    as note_components_text_RichText_;
...
mixin PathsMixin {
  ...
  final Path note_welcome_note_self =
      put("/note/1.welcome/1.note-self", note_welcome_note_self_.page);
  ...
  final Path note_components_text_RichText =
      put("/note/components/text/RichText", note_components_text_RichText_.page);

  final Path note_components_text_Text =
      put("/note/components/text/Text", note_components_text_Text_.page);

  final Path note_layout = put("/note/layout", note_layout_.page);

  final Path note_scrollable_Dismissible =
      put("/note/scrollable/Dismissible", note_scrollable_Dismissible_.page);

  final Path note_selectable = put("/note/selectable", note_selectable_.page);

  final Path note_state_vanilla_state =
      put("/note/state/1.vanilla_state", note_state_vanilla_state_.page);

  final Path note_state_StatefulBuilder =
      put("/note/state/StatefulBuilder", note_state_StatefulBuilder_.page);
}
