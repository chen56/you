...
import 'package:flutter/src/rendering/viewport.dart';import 'dart:core';import 'dart:ui';import 'package:flutter/src/painting/basic_types.dart';import 'package:flutter/src/rendering/viewport_offset.dart';import 'package:flutter/src/rendering/sliver.dart';import 'package:note/mate.dart' show Mate;/// class RevealedOffset
class RevealedOffset$Mate extends RevealedOffset with Mate {/// RevealedOffset RevealedOffset({required double offset, required Rect rect})
RevealedOffset$Mate({/// optionalParameters: {required double offset} , hasDefaultValue:false, defaultValueCode:null
required double offset, /// optionalParameters: {required Rect rect} , hasDefaultValue:false, defaultValueCode:null
required Rect rect, }) : super(offset: offset, rect: rect, ) { mateBuilder = (p) => RevealedOffset$Mate(offset: p.get('offset').build(), rect: p.get('rect').build(), );
...
RenderViewport$Mate({/// optionalParameters: {AxisDirection axisDirection = AxisDirection.down} , hasDefaultValue:true, defaultValueCode:AxisDirection.down
...
RenderSliver? center, /// optionalParameters: {double? cacheExtent} , hasDefaultValue:false, defaultValueCode:null
...
class RenderShrinkWrappingViewport$Mate extends RenderShrinkWrappingViewport with Mate {/// RenderShrinkWrappingViewport RenderShrinkWrappingViewport({AxisDirection axisDirection = AxisDirection.down, required AxisDirection crossAxisDirection, required ViewportOffset offset, Clip clipBehavior = Clip.hardEdge, List<RenderSliver>? children})
RenderShrinkWrappingViewport$Mate({/// optionalParameters: {AxisDirection axisDirection = AxisDirection.down} , hasDefaultValue:true, defaultValueCode:AxisDirection.down
required AxisDirection axisDirection, /// optionalParameters: {required AxisDirection crossAxisDirection} , hasDefaultValue:false, defaultValueCode:null
required AxisDirection crossAxisDirection, /// optionalParameters: {required ViewportOffset offset} , hasDefaultValue:false, defaultValueCode:null
...
required Clip clipBehavior, /// optionalParameters: {List<RenderSliver>? children} , hasDefaultValue:false, defaultValueCode:null
List<RenderSliver>? children, }) : super(axisDirection: axisDirection, crossAxisDirection: crossAxisDirection, offset: offset, clipBehavior: clipBehavior, children: children, ) { mateBuilder = (p) => RenderShrinkWrappingViewport$Mate(axisDirection: p.get('axisDirection').build(), crossAxisDirection: p.get('crossAxisDirection').build(), offset: p.get('offset').build(), clipBehavior: p.get('clipBehavior').build(), children: p.get('children').build(), );
matePut('axisDirection', axisDirection);
matePut('crossAxisDirection', crossAxisDirection);
matePut('offset', offset);
matePut('clipBehavior', clipBehavior);
