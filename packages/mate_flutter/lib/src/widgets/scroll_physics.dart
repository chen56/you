...
class RangeMaintainingScrollPhysics$Mate
    extends _i1.RangeMaintainingScrollPhysics with _i2.Mate {
  ...
  RangeMaintainingScrollPhysics$Mate(
    ...
    matePackageUrl = 'package:flutter/cupertino.dart';
    mateBuilder = (p) =>
        RangeMaintainingScrollPhysics$Mate(parent: p.get('parent').build());
  }
...
class BouncingScrollPhysics$Mate extends _i1.BouncingScrollPhysics
    with _i2.Mate {
...
class ClampingScrollPhysics$Mate extends _i1.ClampingScrollPhysics
    with _i2.Mate {
  ...
  ClampingScrollPhysics$Mate(
    ...
    matePackageUrl = 'package:flutter/cupertino.dart';
    mateBuilder =
        (p) => ClampingScrollPhysics$Mate(parent: p.get('parent').build());
  }
...
class AlwaysScrollableScrollPhysics$Mate
    extends _i1.AlwaysScrollableScrollPhysics with _i2.Mate {
  ...
  AlwaysScrollableScrollPhysics$Mate(
    ...
    matePackageUrl = 'package:flutter/cupertino.dart';
    mateBuilder = (p) =>
        AlwaysScrollableScrollPhysics$Mate(parent: p.get('parent').build());
  }
...
class NeverScrollableScrollPhysics$Mate extends _i1.NeverScrollableScrollPhysics
    with _i2.Mate {
  ...
  NeverScrollableScrollPhysics$Mate(
    ...
    matePackageUrl = 'package:flutter/cupertino.dart';
    mateBuilder = (p) =>
        NeverScrollableScrollPhysics$Mate(parent: p.get('parent').build());
  }
